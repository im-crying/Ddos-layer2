...
print("=" * 50)
print("TOOL DDOS BY MINH KHANG")
print("=" * 50)
print("Đã tải xong cấu hình!")
print(f"- Tổng số user: {len(f1ff72b3f04a389ab96d9a508d5c2cfb)}")
print(f"- Tổng số bot IP: {len(bot_ipv4_list)}")
print(f"- Tổng số proxy: {len(proxy_list)}")
print(f"- Số phương thức tấn công: {len(ALL_METHODS)}")
print("=" * 50)
...
try:
    ...
    print("✓ Kết nối mạng: OK")
except:
    print("✗ Kết nối mạng: FAILED")
finally:
    test_socket.close()

print("\nTool đã sẵn sàng!")
print("Thêm code chính của bạn vào đây...")
